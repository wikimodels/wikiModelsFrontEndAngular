...
@Component({
  selector: 'app-ribbon-tile',
  templateUrl: './ribbon-tile2.component.html',
  styleUrls: ['./ribbon-tile2.component.css']
})
export class RibbonTile2Component implements OnInit, OnDestroy {
