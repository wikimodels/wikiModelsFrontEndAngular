...
@Component({
  selector: 'app-ribbon-tile4',
  templateUrl: './ribbon-tile4.component.html',
  styleUrls: ['./ribbon-tile4.component.css']
})
export class RibbonTile4Component implements OnInit, OnDestroy {
