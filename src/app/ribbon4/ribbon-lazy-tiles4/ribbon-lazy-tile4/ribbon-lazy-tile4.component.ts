...
@Component({
  selector: 'app-ribbon-lazy-tile4',
  templateUrl: './ribbon-lazy-tile4.component.html',
  styleUrls: ['./ribbon-lazy-tile4.component.css']
})
export class RibbonLazyTile4Component implements OnInit, OnDestroy {
