...
@Component({
  selector: 'app-article-banner4',
  templateUrl: './article-banner4.component.html',
  styleUrls: ['./article-banner4.component.css']
})
export class ArticleBanner4Component implements OnInit, OnDestroy {
  sub: Subscription;
  @Input() banner: any;
