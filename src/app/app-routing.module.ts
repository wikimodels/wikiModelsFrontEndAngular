...
import { Ribbon4Component } from './ribbon4/ribbon4.component';

const routes: Routes = [
    { path: '', pathMatch: 'full', redirectTo: '/home' },
    { path: 'home', component: Ribbon4Component},
    ...
    { path: 'article4/:article_id', component: Article4Component },
	...
	// { path: 'article4', loadChildren: () => import('./../app/article4/article4.module').then(m => m.Article4Module)},
