...
@Component({
  selector: 'app-article-banner2',
  templateUrl: './article-banner2.component.html',
  styleUrls: ['./article-banner2.component.css']
})
export class ArticleBanner2Component implements OnInit, OnDestroy {
  sub: Subscription;
  @Input() banner: any;
