...
@Component({
  selector: 'app-ribbon-lazy-tile3',
  templateUrl: './ribbon-lazy-tile3.component.html',
  styleUrls: ['./ribbon-lazy-tile3.component.css']
})
export class RibbonLazyTile3Component implements OnInit, OnDestroy {
